...
def get_reconstruction_gpu2(input, model):
    ...
    return end_time-start_time, img_res
...
model_path = '/home/lengyihong/workspace/domain_adaption/TIP_R1/ConvMLP_2020/results_new/MTSSR3/model_e149.pth'
result_path = '/home/lengyihong/workspace/domain_adaption/TIP_R1/ConvMLP_2020/results_new/MTSSR3/Ours/'
...
for i in range(len(img_path_name)):
    ...
    gt_hyper = loadmat(gt_hyper_name[i])['cube']
    gt_hyper = np.float32(np.array(gt_hyper))
    # gt_hyper = normalize(gt_hyper, max_val=1., min_val=0.)
    
    print(gt_hyper.shape)
    print(img_res.shape)
    mrae.append(compute_MRAE(gt_hyper, img_res))
    print(compute_MRAE(gt_hyper, img_res))
